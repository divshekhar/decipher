...
print("\nBegin DE for finding transposition cipher key\n")
print("Setting population_size = " + str(population_size))
print("Setting max_generation = " + str(max_generation))
print("\n-------------Starting DE algorithm-------------\n")

# start clock
start_time = time.time()
de = DE(CIPHER, generateScore, population_size, max_generation, key_length)
best_individual: Individual = de.run()
# end clock
end_time = time.time()

key = "".join([str(i) for i in best_individual.key])

print("\n-------------DE algorithm completed-------------\n")
print("\nBest Key Found:")
